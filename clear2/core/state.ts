import { Message, PermissionMode, TaskState } from "./types";
 ...
 */
// TODO: 为什么状态可以存储在闭包中，为什么函数式更新可以保证不变性
...
export const selectors = {
  ...
  /** 工具总数 */
  getToolCount: (state: AppState) => state.tools.length + state.mcp.toolCount,
};
...
export const updaters = {
  ...
  /** 更新任务状态 */
  updateTaskStatus:
    (taskId: string, status: TaskState["status"], endTime?: number) =>
    (state: AppState): AppState => {
